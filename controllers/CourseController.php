    ...
    class CourseController {
        ...
        public function store() {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($courseModel->create($title, $description, $instructor_id, $category_id, $price, $level, $imagePath)) {
                    header('Location: ' . BASE_URL . '/index.php?action=instructor_courses&msg=success');
                } else {
        ...
        public function update($id) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($courseModel->update($id, $title, $description, $category_id, $price, $level, $imagePath)) {
                    header('Location: ' . BASE_URL . '/index.php?action=instructor_courses&msg=updated');
                } else {
                    echo "Lỗi cập nhật!";
                }
            }
        ...
        public function delete($id) {
            ...
            if ($course && $course['instructor_id'] == $_SESSION['user']['id']) {
                ...
                header('Location: ' . BASE_URL . '/index.php?action=instructor_courses&msg=deleted');
            } else {
